...
public class Telepotions
{
    ...
    {
        LOGGER.info("Telepotions mod enabled.");
    }
    ...
    public static class RegistryEvents {
        ...
        {
            itemRegistryEvent.getRegistry().registerAll(new RecallPotionItem("recall_potion"),
                    new WormholePotionItem("wormhole_potion"),
                    new TeleportationPotionItem("teleportation_potion"));
